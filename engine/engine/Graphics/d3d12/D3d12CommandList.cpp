...
{
   if(mGpuViewDescriptorPool) {
      mGpuViewDescriptorPool->OwnerHeap()->DeferredFreeDescriptorPool( mGpuViewDescriptorPool, Id() );
      mGpuViewDescriptorPool->OwnerHeap()->DeferredFreeDescriptorPool( mGpuSamplerDescripPool, Id() );
   }
}
...
void CommandList::BindResources( const ResourceBinding& bindings )
{
