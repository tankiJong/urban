...
// 
//    DistanceWeight = saturate(0.5f - length2(EvalPos - PosA));
//    DistanceWeight *= DistanceWeight;
//    DistanceWeight *= DistanceWeight;
//    float a = dot(A, EvalPos - PosA) * DistanceWeight;
//    DistanceWeight = saturate(0.5f - length2(EvalPos - PosB));
//    DistanceWeight *= DistanceWeight;
//    DistanceWeight *= DistanceWeight;
//    float b = dot(B, EvalPos - PosB) * DistanceWeight;
//    DistanceWeight = saturate(0.5f - length2(EvalPos - PosC));
//    DistanceWeight *= DistanceWeight;
//    DistanceWeight *= DistanceWeight;
...
//    float DistanceWeight;
// 
//    DistanceWeight = saturate(0.6f - length2(EvalPos - PosA));
//    DistanceWeight *= DistanceWeight;
//    DistanceWeight *= DistanceWeight;
//    float a = dot(A, EvalPos - PosA) * DistanceWeight;
